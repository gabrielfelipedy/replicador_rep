...
describe('processLine', () => {
  ...
  it('should return null if tipoRegistro is not 3', async () => {
    ...
    const invalidTypeInput = "00000010212025-04-09T12:38:00-0300I080627153291ASCD";
  ...
  it('should handle lines longer than needed, processing correctly', async () => {
    const longInput = "00000010232025-04-09T12:38:00-0300080627153291ASCD_EXTRADATA";
    const expectedLongOutput = "00000010232025-04-09T12:38:00-030080627153291 ASCD_EXTRADATA"; // Note the extra data appended after space
